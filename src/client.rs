...
impl From<Protocol> for String {
    fn from(item: Protocol) -> Self {
        match item {
            Protocol::RDP => String::from("RDP"),
            Protocol::SSH => String::from("SSH"),
            Protocol::VNC => String::from("VNC"),
...
mod tests {
    ...
    fn test_protocol() {
        ...
        let rdp_str: String = rdp.into();
        assert_eq!("RDP", rdp_str);
        assert_eq!("RDP".parse::<Protocol>(), Protocol::RDP);
    }
